//Nom de la classe doit être le même que le nom de fichier en Java et que le constructeur.
...
public class Cours02_stucturePgm {
    ...
    public static void main(String[] args) { //C'est ici que le programme commence
        ...
        new Cours02_stucturePgm(); //instancier ma classe (son nom est Cours02_stucturePgm)
